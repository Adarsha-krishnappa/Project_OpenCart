...
public class TC_015_Validate_GiftCertificate_Functionality extends BaseClass{
	
	@Test(groups= {"regression","master"})
	public void GiftCertficate()
	{
		try {
	        ...
	        scp.UseGiftcertificateOption();
	        scp.SetGiftCode("#10990");
	        scp.ApplyGiftCode();
	        Thread.sleep(4000);
